...
# Loads a paletted image and converts it into a 4-colour CHR for the NES.
# Each palette entry in the original image is mapped to value 0..3,
# with the index decided by chr_color = original_color % 4
#
